      ...
      <Table>
        <TableHeader className="bg-white/5 border-b border-white/10">
          <TableRow className="border-none hover:bg-transparent">
            ...
            <TableHead className="text-neutral-400 font-medium text-xs uppercase tracking-wide">To (Customer)</TableHead>
        ...
        <TableBody>
          {deliveries.map((delivery) => (
            ...
            >
              <TableCell className="font-medium text-white">{delivery.reference}</TableCell>
              <TableCell className="text-neutral-300">{delivery.from}</TableCell>
              <TableCell className="text-neutral-300">{delivery.to}</TableCell>
            ...
            <TableRow>
              <TableCell colSpan={5} className="text-center py-12">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <p className="text-neutral-500 text-sm">No deliveries found.</p>
                </div>
              </TableCell>
            </TableRow>
          )}
